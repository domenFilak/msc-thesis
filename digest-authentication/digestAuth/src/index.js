...
const digestAuthMiddleware = require('./middleware/authMiddleware'); //lasten middleware (vmesna programska koda), za digest authentication
...
app.use(digestAuthMiddleware); //uporabi lasten middleware za vse endpointe (poti) od tukaj naprej

//korenska pot, uporablja digestAuthMiddleware in ob uspešni prijavi se izpiše spodnje sporočilo
app.get('/', (req, res) => {
